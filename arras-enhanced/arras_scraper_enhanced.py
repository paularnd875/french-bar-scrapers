...
class ArrasEnhancedScraper:
    ...
    def extract_complete_lawyer_info(self, lawyer_info: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            # SPÉCIALISATIONS - Détection améliorée
            specializations = set()
            ...
            droit_keywords = [
                ...
                'droit de l\'environnement', 'droit rural', 'droit de l\'urbanisme',
                'droit des assurances', 'droit bancaire', 'droit des transports',
                'droit maritime', 'droit aérien', 'droit de l\'informatique',
            ...
            spec_sections = soup.find_all(['div', 'section', 'ul', 'li'], 
                                         string=re.compile(r'(spécialis|compétenc|domain)', re.I))
            ...
            if specializations:
                lawyer_data["specialisations"] = sorted(list(specializations))[:10]
